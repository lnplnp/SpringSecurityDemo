...
public interface I18nProvider {
  ...
  /**
   * Gets the name of <code>locale</code> to display in the user interface. Each
   * locale is shown in its own language. For example, the "en_US" locale
   * returns "English", the "fi_FI" locale "Suomi", etc.
   * <p>
   * If <code>locale</code> is not in the array returned by
   * {@link #getSupportedLocales()}, an "Unsuppored Locale" string is returned.
   * 
   * @param locale
   ...
   *          message (params look like "{0}", "{1,date}", "{2,time}"), or
  ...
  /**
   * Gets all the locales that this application supports. More specifically, the
   * application's UI can be shown in any of the locales returned by this
   * method.
   * 
