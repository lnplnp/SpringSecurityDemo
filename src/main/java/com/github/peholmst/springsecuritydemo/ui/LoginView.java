...
public class LoginView extends AbstractView {
   ...
   *          the authentication manager to use (must not be <code>null</code>).
   */
      ...
      public void buttonClick(ClickEvent event) {
        ...
        try {
          ...
          getWindow().showNotification(
              getApplication().getMessage("login.badCredentials.title"),
          ...
          getWindow().showNotification(
              getApplication().getMessage("login.disabled.title"),
